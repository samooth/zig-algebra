...
test "bn254_tower: known-answer vs py_ecc reference" {
    ...
    var want_g1g2 = Fp12T.zero();
    want_g1g2.c0.c0 = Fp2.new(Fp.fromInt(8493334370784016972005089913588211327688223499729897951716206968320726508021), Fp.fromInt(3758435817766288188804561253838670030762970764366672594784247447067868088068));
    want_g1g2.c0.c1 = Fp2.new(Fp.fromInt(6565798094314091391201231504228224566495939541538094766881371862976727043038), Fp.fromInt(14656606573936501743457633041048024656612227301473084805627390748872617280984));
    want_g1g2.c0.c2 = Fp2.new(Fp.fromInt(634997487638609332803583491743335852620873788902390365055086820718589720118), Fp.fromInt(19455424343576886430889849773367397946457449073528455097210946839000147698372));
    want_g1g2.c1.c0 = Fp2.new(Fp.fromInt(20049218015652006197026173611347504489508678646783216776320737476707192559881), Fp.fromInt(18059168546148152671857026372711724379319778306792011146784665080987064164612));
    want_g1g2.c1.c1 = Fp2.new(Fp.fromInt(12145052038566888241256672223106590273978429515702193755778990643425246950730), Fp.fromInt(17918828665069491344039743589118342552553375221610735811112289083834142789347));
    want_g1g2.c1.c2 = Fp2.new(Fp.fromInt(6223602427219597392892794664899549544171383137467762280768257680446283161705), Fp.fromInt(7484542354754424633621663080190936924481536615300815203692506276894207018007));

    var want_twothree = Fp12T.zero();
    want_twothree.c0.c0 = Fp2.new(Fp.fromInt(7297928317524675251652102644847406639091474940444702627333408876432772026640), Fp.fromInt(18010865284024443253481973710158529446817119443459787454101328040744995455319));
    want_twothree.c0.c1 = Fp2.new(Fp.fromInt(14179125828660221708486990054318233868908974550229474018509093903907472063156), Fp.fromInt(19672547343219696395323430329000470270122259521813831378125910505067755316037));
    want_twothree.c0.c2 = Fp2.new(Fp.fromInt(10811020225621941034352015694422164943041584464746963243431262955968538467312), Fp.fromInt(18591344525433923700278298641693487837785792806011751060570085671866249379154));
    want_twothree.c1.c0 = Fp2.new(Fp.fromInt(18214296718386486500838507024306049626571830525675768493345345883297201451077), Fp.fromInt(19227311731387426597265504864999881769743583647552324796732605660514141916117));
    want_twothree.c1.c1 = Fp2.new(Fp.fromInt(15463354980731838106439887363063618463783317416732018231077874458188347926701), Fp.fromInt(3765441250413579779915094051038487360437654739171671492016287185303087270469));
    want_twothree.c1.c2 = Fp2.new(Fp.fromInt(21029416079740174485345021549306749850075185576152640151652655104272393297142), Fp.fromInt(19736982780723093346009254617143639137054958583796054069884522103959451721163));

    try testing.expect(pairing(g1, g2).eql(want_g1g2));
    try testing.expect(pairing(g1.scalarMul(@as(u64, 2)), g2.scalarMul(@as(u64, 3))).eql(want_twothree));
}
