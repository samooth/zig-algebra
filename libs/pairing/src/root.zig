...
pub const bn254_tower_pairing = @import("bn254_tower.zig");
pub const bn254_pairing = bn254_tower_pairing;
pub const bn254_pairing_impl = bn254_tower_pairing;
pub const bn254_legacy = @import("bn254.zig");
