...
pub fn build(b: *std.Build) void {
    ...
    const linalg_mod = b.addModule("zig-linalg", .{
        .root_source_file = b.path("src/root.zig"),
        .target = target,
        .optimize = optimize,
    });
    linalg_mod.addImport("zig-algebra-traits", traits_mod);
    linalg_mod.addImport("zig-field", field_mod);
    ...
    example_module.addImport("zig-linalg", linalg_mod);
