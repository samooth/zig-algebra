...
pub const G1_generator = weierstrass.AffinePoint(Fp, G1_a, G1_b).generator(
    // x-coordinate
    Fp.fromInt(0x17F1D3A73197D7942695638C4FA9AC0FC3688C4F9774B905A14E3A3F171BAC586C55E83FF97A1AEFFB3AF00ADB22C6BB),
    // y-coordinate
    Fp.fromInt(0x8B3F481E3AAA0F1A09E30ED741D8AE4FCF5E095D5D00AF600DB18CB2C04B3EDD03CC744A2888AE40CAA232946C5E7E1),
);
